# Solutions to exercise 3 from sheet 10 in Numerics of PDEs
...
J = 6;	# number of meshes to test (k=0..J-1, where h_k = h_0*2^(-k2))
...
ax2.plot(ndof, errors[0]*(np.array(ndof)/ndof[0])**(-1/4.), 'r-', label = '$e_n\propto N^{-1/4}$')
ax2.set_xscale('log')
ax2.set_yscale('log')
