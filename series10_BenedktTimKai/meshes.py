...
def generate_quad_adapt_triangulation(cellsize, boxdim, structedGrid):
    global h
    h = cellsize
    # a string holding the gmsh script commands for a rectangular domain
    # passing the box sidelength as boxdim and h as maximum cellwith
...
boxdim = "+str(boxdim)+";\n\
gridsize = "+str(h)+";\n\
Point(1) = {-boxdim,-boxdim,0.0,gridsize};\n\
Point(2) = {boxdim,-boxdim,0.0,gridsize};\n\
Point(3) = {boxdim,boxdim,0.0,gridsize};\n\
Point(4) = {-boxdim,boxdim,0.0,gridsize};\n\
Point(5) = {-boxdim,0.0,0.0,gridsize*gridsize*0.5};\n\
Point(6) = {boxdim,0.0,0.0,gridsize*gridsize*0.5};\n\
Line(7) = {1,2};\n\
Line(8) = {2,6};\n\
Line(9) = {3,4};\n\
Line(10) = {4,5};\n\
...
def generate_shifted_quad(cellsize, boxdim=1, structedGrid=False):
    global h
    h = cellsize
    # a string holding the gmsh script commands for a rectangular domain
    # passing the box sidelength as boxdim and h as maximum cellwith
